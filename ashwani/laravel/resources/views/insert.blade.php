    ...
    <div class="container w-50 mt-5">
        ...
        <form action="/store" method="post">
            ...
            <div class="md-3 sc">
                ...
                <input type="number" placeholder="Enter The Mobile" name="mobile" class="form-control">
            ...
            <div class="md-3 sc">
                ...
                <input type="password" name="cpass" placeholder="Enter The Password" class="form-control">
                <span style="color: red">@error('cpass'){{$message}}@enderror</span>

            </div>
            <br>
            <input type="submit" name="insert" save="insert" class="btn btn-outline-warning">
        </form>
    </div>
</body>
</html>