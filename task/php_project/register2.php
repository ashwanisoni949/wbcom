...
if(isset($_POST['submit']))
{
	...
	}else
	{
		...
		{
			$insert = "INSERT INTO students(name,email,phone,password,cpassword,token,status) VALUES('$username','$email','$mobile','$pass','$cpass','$token','inactive')";
			$iquery = mysqli_query($conn,$insert);
			if($iquery)
			{
			$subject = "Simple Email Test via PHP";
			$body = "hii, $username. Click here to activate your account http://localhost/php_project/emailverification/activate.php?token=$token";
